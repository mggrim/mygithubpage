...
- 🔄 **Contextual Conversations** - Multi-turn dialogues with memory
- 🎵 **Apple Music Integration** - AI-powered playlist creation
- 🗺️ **Apple Maps Integration** - Location discovery and viewing
- 🤖 **Multiple AI Models** - GPT-3.5, GPT-4, and OpenAI o1 models
- ⚡ **Watch Face Complications** - Quick access from your watch face
